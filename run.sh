...
python main.py --method="ours" --base_model="mlp" --beta1=0.99999 --num_drifts=2 --prediction_threshold=0.3
...
python main.py --method="fixed_uncertainty" --base_model="mlp" --prediction_threshold=0.95 --num_drifts=2
python main.py --method="variable_uncertainty" --base_model="mlp" --prediction_threshold=0.95 --num_drifts=2
python main.py --method="variable_randomized_uncertainty" --base_model="mlp" --prediction_threshold=0.95 --num_drifts=2
