...
class MLPClassifierPytorch(BaseEstimator, ClassifierMixin):
    def __init__(self, hidden_layer_sizes=(100,), activation="relu", *,
                 ...
                 epsilon=1e-8, n_iter_no_change=10, max_fun=15000, use_gpu=False) -> None:
    ...
    def partial_fit(self, X, y):
        return self.fit(X, y, incremental=True)
